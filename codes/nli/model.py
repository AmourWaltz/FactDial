...
class SelfBertForSequenceClassification(BertPreTrainedModel):
...
class BertNLIModel(nn.Module):
    ...
    """
    def __init__(self, model_path=None, gpu=True, bert_type='bert-base', label_num=3, 
                 batch_size=8, reinit_num=0, freeze_layers=False):
